...
c---------------------------------------------------------------------c
c      Parameters used to dimension the arrays in VOFTools in 3D.     c
c---------------------------------------------------------------------c
c      IMPORTANT ADVISE: If you need to modify the values of the      c
c                        parameters 'NS' or 'NV' (to use, for example,c
c                        cells with a higher number of faces or       c
c                        vertices), the VOFTools library must be      c
c                        recompiled with this modified file.          c
c---------------------------------------------------------------------c
c---------------------------------------------------------------------c
